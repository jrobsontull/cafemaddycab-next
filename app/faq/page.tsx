    ...
    <div className="react-container">
      <div className="content frontend faq">
        ...
        <div className="info-box">
          ...
          <Link href={'/how-to-ride'}>How it Works</Link> page. To request a
          ride, please visit our{' '}
          <Link href={'/request-ride'}>Request a Ride</Link> page.
        </div>
        ...
        <div className="info-box">
          ...
          <Link href={'/how-to-ride'}>How it Works</Link> page for more details.
        </div>
